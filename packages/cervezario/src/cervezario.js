 ...
 * @property {obj<(arg?)=>(any[],any[]?)=>any>} - define cerveza named processors.
...
function cervezario(config = {}) {
  return new Cervezario(config)
}
module.exports = cervezario
cervezario.cervezario = cervezario
